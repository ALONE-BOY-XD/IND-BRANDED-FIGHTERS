...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await idk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await ydk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await wdk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await hdk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await sdk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await adk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await bdk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await cdk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await ddk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@ABOUT_KILLER_KING"))
            await edk(functions.channels.JoinChannelRequest(channel="@IND_BRANDED_FIGHTERSS"))
